...
export default function ConsultarSaldo() {
    ...
    const handleCreateAmount = async () => {
        ...
        const details = await creditAccount({
      ...
      <Head>
        ...
        <main>
            <form class="max-w-sm mx-auto">
                ...
                <button type="button" onClick={handleCreateAmount} class="mt-[10px] py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 ">Consignar</button>
            </form>
